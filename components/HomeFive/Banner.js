                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="banner-content">
                                        ...
                                        <p>We strive to help our clients reach their goals by offering them the perfect combination of technology, expertise, and customer service.</p>
                                ...
                                <div className="col-lg-6">
                                    ...
                                    >
                                        <div className="animate-image">
                                            <img src="/images/it-banner/android2b.png" alt="image" />
                                        </div>
                                        <div className="animate-image">
                                            <img src="/images/it-banner/web.jpg" alt="image" />
                                        </div>
                                        <div className="animate-image">
                                            <img src="/images/it-banner/iphone24c.png" alt="image" />
                                        </div>
                                        <div className="animate-image">
                                            <img src="/images/it-banner/tax.jpg" alt="image" />
                                        </div>
                                        <div className="animate-image">
                                            <img src="/images/it-banner/android7c.png" alt="image" />
                                        </div>
                                    </OwlCarousel> : ''}
                                </div>
                            </div>
