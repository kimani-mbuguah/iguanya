    ...
    return (
      <div className="main-content ptb-80">
        <div className="container">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Iguanya.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Iguanya, accessible from{" "}
                <a
                  href="https://iguanya.com"
          ...
          <ul>
            <li>
              <p>By email: info@iguanya.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://iguanya.com/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://iguanya.com/contact
                </a>
              </p>
            </li>
          </ul>
